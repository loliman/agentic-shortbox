...
3. **Given** review feedback exists on a PR and a human comments `ready for rework` in the review conversation, **When** the bot applies the requested follow-up, **Then** it commits to the existing PR head branch and comments success.
